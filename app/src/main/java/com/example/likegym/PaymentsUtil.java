...
public class PaymentsUtil {
    ...
    public static PaymentsClient createPaymentsClient(Context context) {
        Wallet.WalletOptions walletOptions =
                new Wallet.WalletOptions.Builder().setEnvironment(com.example.likegym.Constants.PAYMENTS_ENVIRONMENT).build();
    ...
    private static JSONObject getDirectTokenizationSpecification()
        ...
        JSONObject parameters = new JSONObject(com.example.likegym.Constants.DIRECT_TOKENIZATION_PARAMETERS);
    ...
    private static JSONArray getAllowedCardNetworks() {
        return new JSONArray(com.example.likegym.Constants.SUPPORTED_NETWORKS);
    }
    ...
    private static JSONArray getAllowedCardAuthMethods() {
        return new JSONArray(com.example.likegym.Constants.SUPPORTED_METHODS);
    }
    ...
    private static JSONObject getTransactionInfo(String price) throws JSONException {
        ...
        transactionInfo.put("countryCode", com.example.likegym.Constants.COUNTRY_CODE);
        transactionInfo.put("currencyCode", com.example.likegym.Constants.CURRENCY_CODE);
    ...
    public static JSONObject getPaymentDataRequest(long priceCents) {
      ...
      JSON object. */
            ...
            JSONArray allowedCountryCodes = new JSONArray(com.example.likegym.Constants.SHIPPING_SUPPORTED_COUNTRIES);
